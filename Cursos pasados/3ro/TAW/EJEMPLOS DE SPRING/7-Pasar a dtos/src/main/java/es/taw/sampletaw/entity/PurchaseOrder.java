...
public class PurchaseOrder implements DTO<PurchaseOrderDTO> {
    ...
    public PurchaseOrderDTO toDTO () {
        ...
        dto.setFreightCompany(freightCompany);
        dto.setCustomer(customerByCustomerId.toDTO());
        dto.setProduct(productByProductId.toDTO());
