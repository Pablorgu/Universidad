...
@Entity
public class Customer implements DTO<CustomerDTO> {
    ...
    public CustomerDTO toDTO () {
        ...
        dto.setDiscountCode(this.getDiscountCodeByDiscountCode().getDiscountCode());
        dto.setMicroMarket(this.getMicroMarketByZip().getZipCode());
