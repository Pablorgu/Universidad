...
<form:form action="/customer/guardar" modelAttribute="cliente" method="post">
    ...
    Código de descuento: <form:select path="discountCode"
                                      items="${descuentos}"
                                      itemValue="discountCode" itemLabel="rate"/> <br/>
    Supermercado: <form:select path="microMarket" items="${supermercados}" itemValue="zipCode" itemLabel="zipCode"  /><br/>
