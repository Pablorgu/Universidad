...
public class CentroController {
    ...
    public String doGuardar(@ModelAttribute("titulacion") TitulacionEntity titulacionform, Model model) {
        ...
        TitulacionEntity titulacionantigua = titulacionRepository.findById(titulacionform.getIdtitulacion()).orElse(null);
        ...
        for(AsignaturaEntity a: asignaturaRepository.findAll()){
