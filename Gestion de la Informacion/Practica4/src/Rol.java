...
public class Rol implements Comparable<Rol>
{
    ...
    {
        return (obj instanceof Rol) && (rolName.equals(((Rol)obj).rolName));
    }

    public int hashCode()
    {
        return rolName.hashCode();
    }

	public int compareTo(Rol o) 
	{
		return this.rolName.compareToIgnoreCase(o.rolName);
	}
}
